 ...
 * @author junior
 */
public class CadastrarUsuarioGui extends javax.swing.JFrame {

    /**
     * Creates new form CadastrarUsuarioGui
     */
    public CadastrarUsuarioGui() {
        initComponents();
        setLocationRelativeTo(null);
        atualizarComboBoxPerfil();
        atualizarComboBoxStatus();
    }

    private UsuarioBo usuarioBo = new UsuarioBo();

    private void atualizarComboBoxPerfil() {
        comboBoxPerfil.removeAllItems();
        Stream.of(Perfil.values()).forEach(i -> comboBoxPerfil.addItem(i));
    }

    private void atualizarComboBoxStatus() {
        comboBoxStatus.removeAllItems();
        Stream.of(Status.values()).forEach(i -> comboBoxStatus.addItem(i));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarUsuarioGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
